...
function handleclick(key) {
    /*var index = Array.from(document.querySelectorAll(".drum")).indexOf(this);
        var audio = new Audio("AUDIO/audio"+(index+1)+".mp3");
        audio.play();*/

    switch (key) {
        case "p":
            var p = new Audio("AUDIO/audio1.mp3");
            p.play();
            break;
        case "i":
            var i = new Audio("AUDIO/audio2.mp3");
            i.play();
            break;
        case "m":
            var m = new Audio("AUDIO/audio3.mp3");
            m.play();
            break;
        case "o":
            var o = new Audio("AUDIO/audio4.mp3");
            o.play();
            break;
        case "s":
            var s = new Audio("AUDIO/audio5.mp3");
            s.play();
            break;
        case "a":
            var a = new Audio("AUDIO/audio6.mp3");
            a.play();
            break;
        case "n":
            var n = new Audio("AUDIO/audio7.mp3");
            n.play();
            break;
